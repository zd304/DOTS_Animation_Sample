...
public partial class SkinnedMeshAnimationSystem : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        foreach (var (animationRequests, bonesBuffer)
                 in SystemAPI.Query<DynamicBuffer<AnimationRequest>, DynamicBuffer<BoneEntity>>())
        {
    ...
    // private static void AppendCurve(EntityCommandBuffer ecb, Entity entity, SkinnedMeshAnimationCurve[] curves, int index)
    // {
